...
Reply using plain text only with no formatting markdown symbols.
Prove data that supports your answer (if available).
If you performed computations, show all the calculations you performed.
...
(then show computations if you performed them!)
"""
